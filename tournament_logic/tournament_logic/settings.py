...
SECRET_KEY = 'django-insecure-xi%v^=xqg8z@_oq5pvl*dqqrtdd#7saqdk90(fqs5uf-twuuaf'
...
ROOT_URLCONF = 'tournament_logic.urls'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'tournament_logic/static')
]
